...
void UIPie::RenderCenter (UICanvas & canvas) const
{
	...
	canvas.RenderTriangles (imageStyle->GetSourceCanvas (), mNumSegments, s_triangleScratchBuf.begin ()._Ptr, s_uvsScratchBuf.begin ()._Ptr);
}
...
void UIPie::RenderRing (UICanvas & canvas) const
{
	...
	canvas.RenderTriangles (imageStyle->GetSourceCanvas (), mNumSegments * 2, s_triangleScratchBuf.begin ()._Ptr, s_uvsScratchBuf.begin ()._Ptr);
}
