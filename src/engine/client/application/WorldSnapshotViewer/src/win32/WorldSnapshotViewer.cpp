...
BEGIN_MESSAGE_MAP(WorldSnapshotViewerApp, CWinApp)
	//{{AFX_MSG_MAP(WorldSnapshotViewerApp)
...
WorldSnapshotViewerApp::WorldSnapshotViewerApp (void)
{
}
...
WorldSnapshotViewerApp theApp;

//-------------------------------------------------------------------

BOOL WorldSnapshotViewerApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_WORLDSNAPSHOTVIEWERTYPE,
		RUNTIME_CLASS(WorldSnapshotViewerDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(WorldSnapshotTreeView));
...
int WorldSnapshotViewerApp::ExitInstance()
{
...
void WorldSnapshotViewerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
