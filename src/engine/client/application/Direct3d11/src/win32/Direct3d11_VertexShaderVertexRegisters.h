#ifndef INCLUDED_Direct3d11_VertexShaderVertexRegisters_H
#define INCLUDED_Direct3d11_VertexShaderVertexRegisters_H
...
enum Direct3d11_VertexShaderVertexRegisters
{
	VSVR_position               = 0,
	VSVR_normal                 = 3,
	VSVR_pointSize              = 4,
